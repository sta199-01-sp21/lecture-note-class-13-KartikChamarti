...
```{r data_manhattan}
manhattan <- read_csv("~/R/lecture-note-class-13-KartikChamarti/manhattan.csv")
```
...
**Interpretation**: This means that we are 95% confident the mean apartment
price is between 2299 dollars and 2977 dollars. 
...
**Interpretation**: We are 95% confident the mice proportion interval is 0.69
to 0.797. 
...
**Interpretation:** We are 90% confident that the proportion of mice
living on treatment is within that interval of 0.552 to 0.651.
